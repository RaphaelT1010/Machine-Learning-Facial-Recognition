...
To avoid this type of oversight for projects in the future, it seems that more prior research would have gone a long away. A thing we wish we would've done differently is the type of model we selected for this dataset, as this minor change would've changed our overall trajectory and probably result in a model with higher accuracy. However, we felt pressured to move quickly though as this is something none of us have ever coded before and we didn't know how long coding, troubleshooting, debugging, etc. would take us.
